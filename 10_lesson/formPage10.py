...
class FormPage:
    ...
    @allure.step("Ввести электронный адрес") 
    ...
    @allure.step("Нажать на кнопку subbmit") 
    def click_subbmit (self):
        self.driver.find_element(*self.subbmit).click()

       
    @allure.step("Вернуть аттрибут class по полю zip_code")
    ...
    @allure.step("Вернуть аттрибут class по полю first_name")
    ...
    @allure.step("Вернуть аттрибут class по полю last_name")
    ...
    @allure.step("Вернуть аттрибут class по полю address")
    ...
    @allure.step("Вернуть аттрибут class по полю e_mail")
    ...
    @allure.step("Вернуть аттрибут class по полю phone")
    ...
    @allure.step("Вернуть аттрибут class по полю city")
    ...
    @allure.step("Вернуть аттрибут class по полю сountry")
    ...
    @allure.step("Вернуть аттрибут class по полю job")
    ...
    @allure.step("Вернуть аттрибут class по полю company")
